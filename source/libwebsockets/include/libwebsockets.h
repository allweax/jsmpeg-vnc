...
#define lwsl_err(...) _lws_log(LLL_ERR, __FILE__, __LINE__, __VA_ARGS__)
#define lwsl_user(...) _lws_log(LLL_USER, __FILE__, __LINE__, __VA_ARGS__)

#if !defined(LWS_WITH_NO_LOGS)
/* notice and warn are usually included by being compiled in */
#define lwsl_warn(...) _lws_log(LLL_WARN, __FILE__, __LINE__, __VA_ARGS__)
#define lwsl_notice(...) _lws_log(LLL_NOTICE, __FILE__, __LINE__, __VA_ARGS__)
#endif
/*
...
#define lwsl_notice(...) _lws_log(LLL_NOTICE, __FILE__, __LINE__, __VA_ARGS__)
#endif
#define lwsl_info(...) _lws_log(LLL_INFO, __FILE__, __LINE__, __VA_ARGS__)
#define lwsl_debug(...) _lws_log(LLL_DEBUG, __FILE__, __LINE__, __VA_ARGS__)
#define lwsl_parser(...) _lws_log(LLL_PARSER, __FILE__, __LINE__, __VA_ARGS__)
#define lwsl_header(...)  _lws_log(LLL_HEADER, __FILE__, __LINE__, __VA_ARGS__)
#define lwsl_ext(...)  _lws_log(LLL_EXT, __FILE__, __LINE__, __VA_ARGS__)
#define lwsl_client(...) _lws_log(LLL_CLIENT, __FILE__, __LINE__, __VA_ARGS__)
#define lwsl_latency(...) _lws_log(LLL_LATENCY, __FILE__, __LINE__, __VA_ARGS__)
